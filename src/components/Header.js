    ...
    <>
      <header className="flex flex-col items-center justify-center mb-5 xl:flex-row xl:justify-between">
        ...
        {/* <div>
            ...
            <li className='mx-2'><button className="bg-blue-500 text-white font-bold py-2 px-5 rounded shadow
                                  border-2 border-blue-500
                                  hover:bg-transparent hover:text-blue-500
                                  transition-all duration-300">Download</button></li>
            <li><button className="bg-green-500 text-white font-bold py-2 px-5 rounded shadow
